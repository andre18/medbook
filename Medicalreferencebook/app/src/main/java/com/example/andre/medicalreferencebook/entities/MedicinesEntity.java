...
public class MedicinesEntity {
    ...
    public MedicinesEntity(String name, String description) {
        this.name = name;
        this.description = description;
    }

    public MedicinesEntity(int id, String name, String description) {
        this.id = id;
        this.name = name;
        this.description = description;
    }
    ...
    public boolean equals(Object o) {
        ...
        MedicinesEntity that = (MedicinesEntity) o;
